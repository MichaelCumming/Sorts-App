...
/**
 * An <b>AmbiguityException</b> is thrown when a parsed specification is ambiguous.
 * An ambiguity-exception has an optional detailed message, a <tt>String</tt> object describing the particular exception.
 */
