...
public final class OrdinalForm extends SinglyForm {
    ...
    public boolean sum(Form other) { return this.sum((OrdinalForm)other); }
    ...
    public boolean difference(Form other) { return this.difference((OrdinalForm)other); }

    private boolean difference(OrdinalForm other) {
        this.prepare(other);
        if (this.nil() || (!other.nil() && (!this.individual().complement(other.individual()) ||
            (this.individual().attrDefined() && !this.individual().attribute().difference(other.individual().attribute())))))
                this.purge();
        return (this.individual() != null);
    }

    // returns the PRODUCT of two ordinal forms
    public boolean product(Form other) { return this.product((OrdinalForm)other); }

    private boolean product(OrdinalForm other) {
        this.prepare(other);
        if (this.nil() || other.nil() || !this.individual().common(other.individual()) ||
            (this.individual().attrDefined() && !this.individual().attribute().product(other.individual().attribute())))
                this.purge();
        other.purge();
        return (this.individual() != null);
    }
    ...
    public boolean symdifference(Form other) { return this.symdifference((OrdinalForm)other); }
    ...
    public boolean partition(Form other, Form common) { return this.partition((OrdinalForm)other, (OrdinalForm)common); }
    ...
    private boolean partition(OrdinalForm other, OrdinalForm common) {
        ...
        } else if (!ind.nil()) common.setIndividual(ind);
        if (this.nil()) this.purge();
    ...
    public boolean partOf(Form other) { return this.partOf((OrdinalForm)other); }
    ...
    private boolean partOf(OrdinalForm other) {
        ...
        return (other.individual().contains(this.individual()) &&
            (!this.individual().attrDefined() || this.individual().attribute().partOf(this.individual().attribute())));
    }

    // ADD an individual to this form
    public void add(Element data) { this.add((Individual)data); }
