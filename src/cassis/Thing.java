...
/**
 * The <b>Thing</b> interface extends on the <tt>Object</tt> interface,
 * adding abstract methods for comparing things.
 */
public interface Thing {
    ...
    /**
     * The integer value resulting from a comparison of two things, where
     * the first argument is considered strictly <b>less</b> than the second.
     */
    static final int LESS = -1;
    /**
     * The integer value resulting from a comparison of two things, where
     * the first argument is considered strictly <b>greater</b> than the second.
     */
     ...
     * @return an integer value equal to one of {@link #EQUAL}, {@link #LESS},
     * {@link #GREATER}, or {@link #FAILED}
     */
    ...
    /**
     * Tests whether this thing is <b>greater than or equal</b> to another
     * thing.
     * @param other the comparison thing
     * @return <tt>true</tt> if the comparison holds, <tt>false</tt> otherwise
     */
