...
public final class Arc extends Circle {
	...
	new cassis.visit.vrml.Proto(Arc.class, "icons/label.gif");
    }
     ...
     * @see Individual#Individual(cassis.sort.Sort)
     ...
     * @see #Arc(cassis.sort.Sort, cassis.struct.Vector, cassis.struct.Vector,
     * cassis.struct.Vector, cassis.struct.Vector, cassis.struct.Vector)
     * @see Point
     */
     ...
     * The result equals {@link cassis.Thing#FAILED} if the argument is not an arc.
    ...
    /**
     * Reads an SDL description of an arc from a {@link cassis.parse.ParseReader} object
