...
import cassis.visit.GraphicsVisitor;

public class IccVisitor extends GraphicsVisitor {
    ...
    public void endGroup() {
        ...
        if (this.history.empty())
            this.current = null;
        else this.current = (IccGroup) this.history.pop();
    }
    
    public void point(cassis.struct.Vector position) {
	this.process();
    ...
    public void lineSegment(cassis.struct.Vector tail, cassis.struct.Vector head) { }
