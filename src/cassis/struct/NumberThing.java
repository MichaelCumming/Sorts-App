...
/**
 * The <tt>NumberThing</tt> class provides an implementation of the
 * <tt>Thing</tt> interface to numbers.
 * It implements as final the use counter and all related methods.
 * It also implements as final all specific comparison methods in terms of
 * the general <tt>compare</tt> method.
 */
public abstract class NumberThing extends Number implements Thing {
     ...
     * @exception IndexOutOfBoundsException Occurs when an attempt is made to
     ...
     * @return <tt>true</tt> if this thing is being used, <tt>false</tt>
     * otherwise
     */
