...
public final class ConvertApplication_29_3_2005 {
    
    public static void main(String argv[]) {
        User profile = new User("me");
        //run this application by running this file only: Shift + F6
        String name = "P:\\cumming\\research\\java\\sorts.latest\\src\\applets\\sdl\\convert_29_3_2005.sdl";
        //this one >> String name = "D:\\rudi\\sorts\\classes\\convert.sdl";
